                ...
                <StyledApp>
                  <Content>
                    <Switch>
                      ...
                      <Route path="/actions/:stage/:action/:address/:protocol/:poolName">
                        <ActionsPage />
                      </Route>

                      <Route path="/actions/:stage/:action/:address/:protocol">
                        <ActionsPage />
                      </Route>

                      <Route path="/actions/:stage/:action/:address">
                        <ActionsPage />
                      </Route>

                      <Route path="/actions/:stage/:action">
                        <ActionsPage />
                      </Route>
