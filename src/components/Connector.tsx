...
const Connector = () => {
  ...
  return (
    <>
      <DesktopConnector>
        <Aura connected={!!account} />
        <ConnectorButton onClick={() => setConnecting(true)} connected={!!account}>
          <ConnectorText>
            {!!account ? shortenAddress(account, 8) : "Connnect wallet"}
          </ConnectorText>
        </ConnectorButton>
      </DesktopConnector>
      <MobileConnector>
        <DotContainer>
          <DotAura connected={!!account} />
          <DotCenter connected={!!account} />
        </DotContainer>
      </MobileConnector>
