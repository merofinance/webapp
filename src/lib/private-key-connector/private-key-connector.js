...
var PrivateKeyConnector =
  ...
  (function (_AbstractConnector) {
    _inheritsLoose(PrivateKeyConnector, _AbstractConnector);

    function PrivateKeyConnector(kwargs) {
      var _this3;
    ...
    var _proto = PrivateKeyConnector.prototype;
        ...
        var _temp6 = _catch(
          ...
          function (error) {
            ...
            "development" !== "production"
              ? warning(false, "eth_requestAccounts was 2 unsuccessful, falling back to enable")
              : void 0;
          }
        );
    ...
    _proto.getChainId = function getChainId() {
      ...
      try {
        var _temp12 = function _temp12() {
          function _temp9() {
            if (!chainId) {
              try {
                chainid = 42;
                // chainId = parseSendReturn(window.ethereum.send("net_version", []));
              } catch (_unused) {
                "development" !== "production"
                  ? warning(
                      false,
        ...
        var _temp13 = _catch(
          function () {
            return Promise.resolve(window.ethereum.send("eth_chainId").then(parseSendReturn)).then(
              function (_window$ethereum$send2) {
                chainId = 42;
